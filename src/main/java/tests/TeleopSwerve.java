...
public class TeleopSwerve extends Command{
    ...
    public TeleopSwerve(CommandXboxController controller){
        ...
        this.X = () -> MathUtil.applyDeadband(controller.getLeftY() * flip, JoystickConstants.DEADBAND);
        this.Y = () -> MathUtil.applyDeadband(controller.getLeftX() * flip, JoystickConstants.DEADBAND);
        this.rotation = () -> MathUtil.applyDeadband(controller.getRightX() * flip, JoystickConstants.DEADBAND);
